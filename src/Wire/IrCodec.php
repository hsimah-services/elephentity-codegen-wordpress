...
namespace Eleph\Gen\WordPress\Wire;

use BackedEnum;
use Eleph\Gen\WordPress\Ir\ActionDefinition;
use Eleph\Gen\WordPress\Ir\ArgumentDefinition;
use Eleph\Gen\WordPress\Ir\EdgeDefinition;
use Eleph\Gen\WordPress\Ir\EntityDefinition;
use Eleph\Gen\WordPress\Ir\FieldDefinition;
use Eleph\Gen\WordPress\Ir\PatternDeclaration;
use Eleph\Gen\WordPress\Ir\PolicyDefinition;
